...
fn initialize_tile_palette(editor_state: &mut EditorState) {
    ...
    editor_state.world.tile_palette.decoration_tiles = vec![
        ...
        TilePaletteEntry { id: 150, name: "Flowers".to_string(), path: "tiles/Outdoor_decoration/Flowers.png".to_string(), has_collision: false },
        TilePaletteEntry { id: 151, name: "Fountain".to_string(), path: "tiles/Outdoor_decoration/Fountain.png".to_string(), has_collision: true },
        TilePaletteEntry { id: 152, name: "Well".to_string(), path: "tiles/Outdoor_decoration/Well.png".to_string(), has_collision: true },
        TilePaletteEntry { id: 153, name: "Benches".to_string(), path: "tiles/Outdoor_decoration/Benches.png".to_string(), has_collision: false },
        TilePaletteEntry { id: 154, name: "Fences".to_string(), path: "tiles/Outdoor_decoration/Fences.png".to_string(), has_collision: true },
        TilePaletteEntry { id: 155, name: "Fence Big".to_string(), path: "tiles/Outdoor_decoration/Fence_Big.png".to_string(), has_collision: true },
        TilePaletteEntry { id: 156, name: "Barrels".to_string(), path: "tiles/Outdoor_decoration/barrels.png".to_string(), has_collision: true },
        TilePaletteEntry { id: 157, name: "Hay Bales".to_string(), path: "tiles/Outdoor_decoration/Hay_Bales.png".to_string(), has_collision: true },
        TilePaletteEntry { id: 158, name: "Lanterns".to_string(), path: "tiles/Outdoor_decoration/Lanter_Posts.png".to_string(), has_collision: true },
        TilePaletteEntry { id: 159, name: "Camp Decor".to_string(), path: "tiles/Outdoor_decoration/Camp_Decor.png".to_string(), has_collision: false },
        TilePaletteEntry { id: 160, name: "Outdoor Decor".to_string(), path: "tiles/Outdoor_decoration/Outdoor_Decor.png".to_string(), has_collision: false },
        TilePaletteEntry { id: 161, name: "Signs".to_string(), path: "tiles/Outdoor_decoration/Signs.png".to_string(), has_collision: true },
        TilePaletteEntry { id: 162, name: "Boat".to_string(), path: "tiles/Outdoor_decoration/Boat.png".to_string(), has_collision: true },
    ];
...
fn initialize_tilesets(editor_state: &mut EditorState) {
    ...
    let outdoor_decor_tileset = TilesetDefinition {
        ...
        sources: vec![
            TileSource::SingleImage {
                path: "tiles/Outdoor_decoration/Flowers.png".to_string(),
                tile_index: 0,
                name: "Flowers".to_string(),
                has_collision: false,
            },
            TileSource::SingleImage {
                path: "tiles/Outdoor_decoration/Fountain.png".to_string(),
                tile_index: 0,
                name: "Fountain".to_string(),
                has_collision: true,
            },
            TileSource::SingleImage {
                path: "tiles/Outdoor_decoration/Well.png".to_string(),
                tile_index: 0,
                name: "Well".to_string(),
                has_collision: true,
            },
            TileSource::SingleImage {
                path: "tiles/Outdoor_decoration/Benches.png".to_string(),
                tile_index: 0,
                name: "Benches".to_string(),
                has_collision: false,
            },
            TileSource::Spritesheet {
                path: "tiles/Outdoor_decoration/Fences.png".to_string(),
                tile_width: 16,
                tile_height: 16,
                margin: 0,
                spacing: 0,
            ...
            TileSource::SingleImage {
                path: "tiles/Outdoor_decoration/Fence_Big.png".to_string(),
                tile_index: 0,
                name: "Fence Big".to_string(),
                has_collision: true,
            },
            TileSource::SingleImage {
                path: "tiles/Outdoor_decoration/barrels.png".to_string(),
                tile_index: 0,
                name: "Barrels".to_string(),
                has_collision: true,
            },
            TileSource::SingleImage {
                path: "tiles/Outdoor_decoration/Hay_Bales.png".to_string(),
                tile_index: 0,
                name: "Hay Bales".to_string(),
                has_collision: true,
            },
            TileSource::SingleImage {
                path: "tiles/Outdoor_decoration/Lanter_Posts.png".to_string(),
                tile_index: 0,
                name: "Lantern Posts".to_string(),
                has_collision: true,
            },
            TileSource::SingleImage {
                path: "tiles/Outdoor_decoration/Camp_Decor.png".to_string(),
                tile_index: 0,
                name: "Camp Decor".to_string(),
                has_collision: false,
            },
            TileSource::SingleImage {
                path: "tiles/Outdoor_decoration/Outdoor_Decor.png".to_string(),
                tile_index: 0,
                name: "Outdoor Decor".to_string(),
                has_collision: false,
            },
            TileSource::SingleImage {
                path: "tiles/Outdoor_decoration/Signs.png".to_string(),
                tile_index: 0,
                name: "Signs".to_string(),
                has_collision: true,
            },
            TileSource::SingleImage {
                path: "tiles/Outdoor_decoration/Boat.png".to_string(),
                tile_index: 0,
                name: "Boat".to_string(),
                has_collision: true,
            },
