...
/// Initialize spawn points in the world
/// Call this from your world setup system
pub fn initialize_spawn_points(mut spawn_registry: ResMut<SpawnRegistry>) {
    info!("Initializing spawn points...");

    // Register enemy spawns
    ...
    info!("Registered {} spawn points", spawn_registry.spawn_points.len());
}
